...
ax.set_xticklabels(protection_counts.conservation_status.values, rotation=25)
...
ax.set_xticklabels(obs_by_park.park_name.values, rotation=25)
...
#Baseline = 15
# Min detectable = 5 / 15 = 33.3333333%
# Significance = 90%
Sample_size = 870
...
weeks_at_Bryce = 870 / 250
weeks_at_yellowstone = 870 / 507
